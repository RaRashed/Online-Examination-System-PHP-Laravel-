        ...
        <div class="box">
            ...
            <div class="panel mb-none">
                <div class="panel-content bg-scale-0">
                   <form action="{{route('student.new_student')}}" class="database_operation1">
            @csrf
                       ...
                       <button class="btn btn-primary btn-block"> Student Sign Up</button>
                        
                        </div>
                        <div class="form-group text-center">
                            Have an account?, <a href="{{route('student.signin')}}">Sign In</a>
                        </div>
                    </form>
                </div>
            </div>
